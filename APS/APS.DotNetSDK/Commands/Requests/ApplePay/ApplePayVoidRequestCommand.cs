...
{
    public class ApplePayVoidRequestCommand : RequestCommand
    {
        public ApplePayVoidRequestCommand(string sdkConfigurationId = null)
        {
        ...
        private ApplePayVoidRequestCommand() {}
        ...
        {
            var anonymized = new ApplePayVoidRequestCommand()
            {
