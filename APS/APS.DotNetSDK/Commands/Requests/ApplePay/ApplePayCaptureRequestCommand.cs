...
{
    public class ApplePayCaptureRequestCommand : RequestCommand
    {
        public ApplePayCaptureRequestCommand(string sdkConfigurationId = null)
        {
        ...
        protected ApplePayCaptureRequestCommand() {}
        ...
        {
            var anonymized = new ApplePayCaptureRequestCommand()
            {
