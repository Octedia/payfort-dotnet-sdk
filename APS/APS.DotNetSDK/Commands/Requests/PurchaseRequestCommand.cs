...
{
    public class PurchaseRequestCommand : RequestCommand
    {
        private string _rememberMe;
        private string _installments;
        public PurchaseRequestCommand(string sdkConfigurationId = null)
        {
        ...
        /// <summary>
        /// This for standard and custom checkout
        /// </summary>
        ...
        public override void ValidateMandatoryProperties()
        {
            ...
            {
                if (!(Installments == "STANDALONE" || Installments == "YES" || Installments == "NO" || Installments == "HOSTED"))
                {
                    throw new ArgumentException("Installments should be \"STANDALONE\",\"YES\", \"NO\" or \"HOSTED\"", $"Installments");
                }
            }
        ...
        {
            var anonymized = new PurchaseRequestCommand()
            {
