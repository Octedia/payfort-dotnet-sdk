...
namespace APS.DotNetSDK.Maintenance
{
    public interface IMaintenanceOperations : IDisposable
    {
        ...
        Task<AuthorizeResponseCommand> AuthorizeAsync(AuthorizeRequestCommand command, string sdkConfigurationId = null);
        ...
        /// <exception cref="Exception">Get the exception when there is an issue to the payment gateway</exception>
        /// <exception cref="Exception">Get the exception when there is an issue to the payment gateway</exception>
        Task<PurchaseResponseCommand> PurchaseAsync(PurchaseRequestCommand command, string sdkConfigurationId = null);
        ...
        /// <exception cref="Exceptions.SignatureException">Get the exception when signature mismatch</exception>
        /// <exception cref="Exception">Get the exception when there is an issue to the payment gateway</exception>
        Task<RefundResponseCommand> RefundAsync(RefundRequestCommand command, string sdkConfigurationId = null);
        ...
        /// <exception cref="Exceptions.SignatureException">Get the exception when signature mismatch</exception>
        /// <exception cref="Exception">Get the exception when there is an issue to the payment gateway</exception>
        Task<CheckStatusResponseCommand> CheckStatusAsync(CheckStatusRequestCommand command, string sdkConfigurationId = null);
    }
}